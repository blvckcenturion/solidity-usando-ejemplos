...
contract Primitivos {
    ...
    // Se debe hacer uso de payable() para poder definir un address payable realizando una conversion de address a address payable
    address payable addrPayable = payable(0x95a647B3d8a3F11176BAdB799b9499C671fa243a); 
